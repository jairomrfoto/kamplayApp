...
interface Props {
  monitor: Monitor;
  onSave: (updatedMonitor: Monitor) => void;
  onCancel: () => void;
}

const MonitorProfileForm = ({ monitor, onSave, onCancel }: Props) => {
  const [formData, setFormData] = useState({
    ...monitor,
    experiencia: [...(monitor.experiencia || [])],
...
export default MonitorProfileForm;