  ...
  return (
    <div className="flex flex-col md:flex-row gap-6 justify-center items-center max-w-3xl mx-auto px-4 py-12">
      <button
        ...
        className="group w-full md:w-72 bg-orange-500 hover:bg-orange-600 text-white rounded-xl p-6 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl"
      >
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="text-center">
            ...
            <p className="text-orange-100">Para monitores y organizadores</p>
          </div>
        </div>
      </button>
